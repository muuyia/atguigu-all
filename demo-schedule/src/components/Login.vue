...
<!-- https://www.bilibili.com/video/BV1UN411x7xe/?p=161&spm_id_from=333.880.my_history.page.click&vd_source=14551025f000a7403c153e5a0e5f8140 -->
<template>
  <div>
      <h3 class="ht">请登录</h3>
...
<style scoped>
    ...
    .btn1{
      ...
      border-radius:4px;
      width:60px;
      background-color:antiquewhitel;
    }
